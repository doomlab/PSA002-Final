...
\begin{figure}
\includegraphics[width=3.2in]{includes/fig/fig2a} \caption{Procedure of the sentence-picture verification task, with an example of matching orientation.}\label{fig:fig01}
\end{figure}
...
pp.~13 - 15. \url{https://psyarxiv.com/t2pjv/}{]}.
...
(\url{https://codeocean.com/capsule/9287673}). Appendix B summarizes the
...
\begin{tabular}{lllcc}
\toprule
Condition & \multicolumn{1}{c}{Item.1} & \multicolumn{1}{c}{Item.2} & \multicolumn{1}{c}{Participant.Answer} & \multicolumn{1}{c}{Number}\\
\midrule
Sentence-Picture
Critical
...
Horizontal & Yes & 6.00\\
Sentence-Picture
Filler & Sentence & Picture & No & 24.00\\
Picture-Picture
Critical
...
Horizontal & Yes & 6.00\\
Picture-Picture
Filler & Picture & Picture & No & 24.00\\
\bottomrule
\end{tabular}
...
(Stanfield \& Zwaan, 2001), a memory check test was carried out after
...
influencing participants\textquotesingle{} attention during experiments
...
of the embodied account (Bernabeu, 2022; Louwerse et al., 2015), whereas the
...
\subsubsection{\texorpdfstring{\emph{b} values}{b values}}\label{b-values}}
...
\begin{tabular}{lll}
\toprule
Language & \multicolumn{1}{c}{Coefficient} & \multicolumn{1}{c}{SE}\\
\midrule
Arabic & 28.27 & 3.36\\
English & 33.02 & 0.77\\
German & 31.38 & 1.91\\
