...
Athanasopoulos, P. (2023).
Linguistic relativity.
In J. Culpeper (Ed.), \emph{The Routledge Handbook of Language and Mind} (pp. 469--477).
Routledge.
...
In L. Shapiro (Ed.), \emph{The Routledge Handbook of Embodied Cognition} (pp. 145--156).
Routledge.
...
\emph{Psychonomic Bulletin \& Review}, \emph{9}(4), 625--636.
