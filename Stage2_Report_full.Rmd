...
SP_V_noout %>% 
 ...
 booktabs = TRUE,
 escape = FALSE,
 col.names = c("Language","Accuracy Percentages","Mismatching","Matching","Match Advantage"),
 align = c("l",rep("c",4)),
 caption = "Descriptive Statistics by Language"
 ) %>% 
  kable_styling(latex_options="scale_down") %>% 
  footnote("*Note*. Average accuracy percentage, Median response times and median absolute deviations (in parentheses) per match condition (Mismatching, Matching); Match advantage (difference in response times).")
```
